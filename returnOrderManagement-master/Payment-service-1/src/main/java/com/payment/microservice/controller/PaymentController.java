...
//	o	GET: /ProcessPayment (Input: CreditCardNumber, CreditLimit, ProcessingCharge | Output (CurrentBalance)
	...
	public int ProcessPayment(@PathVariable Integer CreditCardNumber, @PathVariable int CreditLimit,
		...
		return CreditLimit - ProcessingCharge;
	}

//	o	POST: /ReversePayment(Input: CreditCartNumber, CreditLimit, ProcessingCharge | Output (Updated Current Balance)
