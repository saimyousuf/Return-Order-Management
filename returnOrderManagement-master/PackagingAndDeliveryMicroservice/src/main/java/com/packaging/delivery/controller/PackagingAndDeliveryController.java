...
public class PackagingAndDeliveryController {
	...
	public  ResponseEntity<PackagingAndDeliveryDTO> calculatePackagingAndDeliveryCharge(@PathVariable String type, @PathVariable Integer count,@RequestHeader(name = "auth", required = true)String token) throws InvalidTokenException{
		try {
